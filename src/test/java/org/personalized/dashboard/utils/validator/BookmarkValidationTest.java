...
public class BookmarkValidationTest {
    ...
    public void testBookmarkValidation(){
        ...
        Assert.assertEquals("Error 2 is MAX_BOOKMARK_URL_LENGTH_EXCEEDED", ErrorCodes.MAX_BOOKMARK_URL_LENGTH_EXCEEDED.name(),errorEntities.get(1).getName());
        ...
        Assert.assertEquals("Error 1 is INVALID_URL", ErrorCodes.INVALID_URL.name(), errorEntities.get(0).getName());
        Assert.assertEquals("Error 2 is MAX_BOOKMARK_URL_LENGTH_EXCEEDED", ErrorCodes.MAX_BOOKMARK_URL_LENGTH_EXCEEDED.name(),errorEntities.get(1).getName());
        Assert.assertEquals("Error 3 is MAX_BOOKMARK_NAME_LENGTH_EXCEEDED", ErrorCodes.MAX_BOOKMARK_NAME_LENGTH_EXCEEDED.name(), errorEntities.get(2).getName());
        Assert.assertEquals("Error 4 is MAX_BOOKMARK_CONTENT_LENGTH_EXCEEDED", ErrorCodes.MAX_BOOKMARK_CONTENT_LENGTH_EXCEEDED.name(), errorEntities.get(3).getName());
    }
}
