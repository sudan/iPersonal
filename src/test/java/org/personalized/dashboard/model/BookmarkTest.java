...
public class BookmarkTest {
    ...
    public void bookmarkEntityTest() {
        Bookmark bookmark = new Bookmark("BOK123456789", "google", "search engine", "http://www" +
                ".google.com");
        ...
        Assert.assertEquals("Description given to bookmark is search engine", "search engine",
                bookmark.getDescription());
        Assert.assertEquals("URL of the bookmark is http://www.google.com", "http://www.google" +
                ".com", bookmark.getUrl());
        Assert.assertNull("CreatedOn is null on creation.Hence only Data Layer can set it",
                bookmark.getCreatedOn());
        Assert.assertNull("modifiedAt is null.Hence only data layer can set it", bookmark
                .getModifiedAt());
        ...
        Assert.assertEquals("Description given to bookmark is yahoo engine", "yahoo engine",
                bookmark.getDescription());
        Assert.assertEquals("URL of the bookmark is http://www.yahoo.com", "http://www.yahoo" +
                ".com", bookmark.getUrl());
