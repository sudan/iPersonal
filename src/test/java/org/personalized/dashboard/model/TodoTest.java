...
public class TodoTest {
    ...
    public void todoEntityTest(){
        ...
        Assert.assertTrue("Number of tasks in TODO123456789 is 3", todo.getTasks().size() == 3);
        ...
        Task task4 = new Task("TASD23456789", Priority.HIGH, "name4","task4");
        todo.addTask(task4);
        ...
        Assert.assertEquals("Task4 priority is HIGH", Priority.HIGH, todo.getTasks().get(3).getPriority());
