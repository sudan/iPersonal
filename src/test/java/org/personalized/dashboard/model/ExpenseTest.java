...
public class ExpenseTest {
    ...
    public void testExpenseEntity() throws ParseException{
        ...
        Bill bill2 = new Bill("BIL123456987", "bill2", "description2", 150.0, Currency.getInstance("USD"), simpleDateFormat.parse("2015-11-02"));
        ...
        Assert.assertEquals("Bill2 id BIL123456987", "BIL123456987", expense.getBills().get(1).getBillId());
        ...
        Assert.assertEquals("Bill1 currency is USD", "USD", expense.getBills().get(0).getCurrency().getCurrencyCode());
        Assert.assertEquals("Bill2 currency is USD", "USD", expense.getBills().get(1).getCurrency().getCurrencyCode());
        ...
        Assert.assertEquals("Bill1 date is 2015-11-02", "2015-11-02", simpleDateFormat.format(expense.getBills().get(1).getDate()));
