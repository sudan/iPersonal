...
db.expenses.ensureIndex({ categories : 1 })

db.diaries.ensureIndex({ user_id : 1 })
db.diaries.ensureIndex({ created_on : -1 })
db.diaries.ensureIndex({ modified_at : -1 })
db.diaries.ensureIndex({ is_deleted : 1 })
